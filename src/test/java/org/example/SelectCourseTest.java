...
//    AddCourse add;
    ...
    void selectCourse() {
        ArrayList<Integer> testArray = new ArrayList<Integer>() {{
            ...
            add(select.selectCourse("", "", "", "企業管理學系", "劉峰旗", "", ""));
            add(select.selectCourse("", "會計學(二)", "", "企業管理學系", "", "", ""));
            add(select.selectCourse("3892", "", "", "", "", "", ""));
            add(select.selectCourse("1360", "", "", "", "", "", "8"));
            add(select.selectCourse("20221204", "", "", "", "", "", ""));
            add(select.selectCourse("", "", "", "", "不要亂", "", "8"));
            add(select.selectCourse("", "邏輯設計實習", "", "", "", "", "6"));
        }};     // 14筆
        ...
        assertEquals(117, testArray.get(4));    // 5
